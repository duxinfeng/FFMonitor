...
//    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%d FPS",(int)round(fps)]];
//    [string addAttribute:NSFontAttributeName value:_subFont range:NSMakeRange(0, string.length)];
//    [string addAttribute:NSFontAttributeName value:_font range:NSMakeRange(string.length-3, 3)];
//    [string addAttribute:NSForegroundColorAttributeName value:color range:NSMakeRange(0, string.length)];
//    [string addAttribute:NSForegroundColorAttributeName value:[UIColor whiteColor] range:NSMakeRange(string.length-3, 3)];
//
